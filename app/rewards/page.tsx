      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="p-4 md:p-8 space-y-6">
          {checking ? (
            ...
            <div className="glass-card p-6 border border-primary/50 bg-primary/5">
              <div className="flex items-center gap-3 mb-4">
                <XCircle className="w-6 h-6 text-primary" />
                <h2 className="text-lg font-bold text-primary">Not Eligible</h2>
              </div>
              <p className="text-sm text-gray-300 mb-4">
                You need to hold at least <span className="font-bold text-primary">1,000,000 VAULT</span> tokens to access rewards.
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-400">Your VAULT Balance:</span>
                  <span className="font-semibold text-primary">{Number.parseFloat(uchainBalance).toLocaleString()} VAULT</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Required:</span>
                  <span className="font-semibold text-primary">{required.toLocaleString()} VAULT</span>
                </div>
              </div>
            </div>
          ) : (
            <>
              {/* Rewards Balance */}
              <div className="glass-card p-6 border border-primary/50 bg-primary/10">
                <div className="flex items-center gap-3 mb-4">
                  <CheckCircle className="w-6 h-6 text-primary" />
                  <h2 className="text-lg font-bold text-primary">Eligible for Rewards</h2>
                </div>
              ...
              {/* Messages */}
              {error && (
                <div className="glass-card p-4 border border-primary/50 bg-black/60">
